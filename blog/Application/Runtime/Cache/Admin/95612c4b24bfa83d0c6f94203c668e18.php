  ...
  <div class="tab">
    ...
    <div class="tab-body"> <br />
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" action="/index.php/Admin/Category/addok">
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea name="remark" class="input" rows="5" cols="50" placeholder="请填写分类描述" data-validate="required:请填写分类描述"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="label">
            ...
            <div class="field">
              <input type="text" class="input" id="sort" name="sort" size="50" placeholder="请填写排序编号0-50;功能正在开发!!" data-validate="required:请填写排序编号" />
            </div>
          </div>
