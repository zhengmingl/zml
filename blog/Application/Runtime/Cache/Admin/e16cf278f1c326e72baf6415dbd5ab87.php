  ...
  <div class="tab">
    ...
    <div class="tab-body"> <br />
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" action="/index.php/Admin/Article/addok" enctype='multipart/form-data'>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <select name="cateid" class="select">
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value='<?php echo ($row["cateid"]); ?>'>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea name="miaoshu" class="input" rows="5" cols="50" placeholder="请填写文章描述" data-validate="required:请填写文章描述"></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="label">
